...
public class VAGoatHorn17 {
    ...
    public void addRecipe() {
        ...
        ShapedRecipe recipe2 = new ShapedRecipe(new NamespacedKey(plugin, "veg_goat_horn_screaming_1"), new ItemStack(Material.getMaterial("GOAT_HORN"), 4))
                .shape(
                        " G ",
                        "SMD",
                        " P ")
